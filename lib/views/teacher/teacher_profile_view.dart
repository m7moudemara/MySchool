...
class _TeacherProfileViewState extends State<TeacherProfileView> {
  ...
  Widget _buildInfoCard() {
    return Container(
      ...
      child: Column(
        children: [
          _buildInfoItem("assets/id.png", "345678899765"),
          SizedBox(height: 16),
          _buildInfoItem("assets/teachericon.png", "Mathematics Teacher"),
          SizedBox(height: 16),
          _buildInfoItem("assets/image.png", "Graduated at University"),
          SizedBox(height: 16),
          _buildInfoItem("assets/school.png", "Teacher in School"),
          SizedBox(height: 16),
