  ...
  class _AddClassViewState extends State<AddClassView> {
    ...
    [
      DropdownMenuItem(value: "garade 1", child: Text("garade 1")),
      DropdownMenuItem(value: "garade 2", child: Text("garade 2")),
      DropdownMenuItem(value: "garade 3", child: Text("garade 3")),
      DropdownMenuItem(value: "garade 4", child: Text("garade 4")),
    ];  
    ...
    void openForm({ClassEntity? entity}) {
      setState(() {
        ...
        selectedGrade = entity?.subject.replaceAll("Grade ", "");
      });
    }
  ...
  void dispose() {
    ...
    items: [
      ...
      CreateButton(
        ...
        enabled: classNameController.text.isNotEmpty && selectedGrade != null,
        onPressed: () {
