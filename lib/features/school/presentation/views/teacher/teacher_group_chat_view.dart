...
class TeacherGroupChatView extends StatefulWidget {
  static final String id = "/StudentGroupChatView";

  const TeacherGroupChatView({super.key});

  @override
  State<TeacherGroupChatView> createState() => _TeacherGroupChatViewState();
}

class _TeacherGroupChatViewState extends State<TeacherGroupChatView> {
