...
class TeacherConversationView extends StatefulWidget {
  static final String id = "/TeacherConversationView";

  const TeacherConversationView({super.key});

  @override
  State<TeacherConversationView> createState() => _TeacherConversationViewState();
}

class _TeacherConversationViewState extends State<TeacherConversationView> {
